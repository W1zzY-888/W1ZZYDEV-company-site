const translations = {
  ru: {
    ...
    roadOneTitle: "Образ",
    roadOneText: "Настраиваем характер проекта: цвет, ритм, типографику и визуальные акценты под конкретный бренд.",
    roadTwoTitle: "Сценарий",
    roadTwoText: "Продумываем путь посетителя: что увидеть первым, где довериться и как быстро перейти к действию.",
    roadThreeTitle: "Запуск",
    roadThreeText: "Собираем адаптивную верстку, переводы, контакты и аккуратную публикацию без лишнего шума.",
  ...
  en: {
    ...
    roadOneTitle: "Identity",
    roadOneText: "We tune the project character: color, rhythm, typography and visual accents for a specific brand.",
    roadTwoTitle: "Scenario",
    roadTwoText: "We plan the visitor path: what to see first, where to build trust and how to move to action.",
    roadThreeTitle: "Launch",
    roadThreeText: "We assemble responsive layout, translations, contacts and clean publishing without extra noise.",
